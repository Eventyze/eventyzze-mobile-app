...
import { formatDate, formatDate2 } from '../../utilities/utilities';
  ...
  useEffect(()=> {
    const loadDataFromParams = () => {
      setEventData({
        ...
        earlyBirdStatus: params.earlyBirdStatus === 'true',
        earlyBirdAmount: params.earlyBirdAmount || "",
        earlyBirdDeadline: params.earlyBirdDeadline || "",
      });
    ...
    />
      ...
      <ScrollView className="mb-20">
        ...
        >
          ...
          {/* Early Bird Cost */}
          {eventData.earlyBirdStatus &&
          <Text className="text-2xl pl-4 mt-6 text-center pr-4 bg-white"
          style={{fontFamily: "BarlowBold"}}
          >
          {`${eventData.earlyBirdAmount} ${eventData.currency} (Early birds until ${formatDate2(eventData.earlyBirdDeadline)})` || "Loading Early Birds Cost..."}
          </Text>
          }
          ...
          style={{fontFamily: "BarlowBold"}}
          >
          {eventData.cost || "Loading cost..."} {eventData.currency || "Loading event cost currency..."} after {formatDate2(eventData.earlyBirdDeadline)}
          </Text>
...
export default ThirdEventCreationPage;
